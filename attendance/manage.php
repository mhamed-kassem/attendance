...
if($studentwillSentWarning != null)
{
    ...
    {
        $instructor=new Instructor("WarningWarningWarningWarningWarning",$notifymasssage);
        $notify=new NotifyApplied($studentwillSentWarning[$x][1],$studentwillSentWarning[$x][0]);
